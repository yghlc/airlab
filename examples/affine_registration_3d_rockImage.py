...
def main():
    ...
    # due to the limit of GPU memory,
    fixed_image = read_image_array_to_tensor('46', [(800,1100),(125,825), (125,825)], device)

    moving_image = read_image_array_to_tensor('47', [(800,1100),(125,825), (125,825)], device)
